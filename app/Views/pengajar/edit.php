...
<section class="content">
    ...
    <div class="card">
        <div class="container-fluid card-body">
            <form method="POST" action="<?php echo base_url('/pengajar/update'); ?>" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input autocomplete="off" required type="text" placeholder="Masukkan tahun masuk" class="form-control" id="thn_masuk" name="thn_masuk" value="<?= $pengajar->thn_masuk ?>" maxlength="4">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input autocomplete="off" type="radio" name="keterangan" value="Active" <?php if ($pengajar->keterangan == 'Active') echo 'checked' ?>> Active<br>
                        <input autocomplete="off" type="radio" name="keterangan" value="Passive" <?php if ($pengajar->keterangan == 'Passive') echo 'checked' ?>> Passive<br>
                    </div>
                </div>
