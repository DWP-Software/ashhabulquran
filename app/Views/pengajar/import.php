...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <?php if (session()->getFlashdata('warning_pengajar')) : ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <p>No | Nama | Tempat Lahir | Tanggal Lahir | Jenis Kelamin | Tahun Masuk | No HP | Keterangan</p>
                        </div>
                        <?php
                        echo form_open_multipart('pengajar/proses');
                        ?>
