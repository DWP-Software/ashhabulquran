                ...
                <div class="card">
                    <div class="row">
                        <div class="col-lg-3 col-md-5" style="padding: 3vh;">
                            <img style="width: 40vh;" src="/pengajarimg/<?= $user->foto; ?>">
                        </div>
                        <div class="col" style="padding: 3vh;">
                            <h3><b><?= $user->nama; ?></b></h3>
                            <table class="table">
                                <tr>
                                    <td>Username Pengajar</td>
                                    <td> : <?= $isi->username; ?></td>
                                </tr>
                                <tr>
                                    <td>Nomor Pengajar</td>
                                    <td> : <?= $user->no_pengajar; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Gaji</td>
                                    <td> : <b><u>Rp<?= number_format($gaji, 2, ',', '.') ?></u></b></td>
                                </tr>
                                <tr>
                                    <td>Keterangan</td>
                                    <?php if ($user->keterangan == "Active") { ?>
